...
source('01_Get_Tools.R')
source('02_Get_Tokens.R')
source('03_Get_Loughran_McDonald.R')
source('04_Get_TESI.R')
source('05_Get_TEPU.R')
source('06_Get_Ipea_Dataset.R')
source('07_Get_Stationary.R')
source('08_Get_Lags.R')
